...
import threading
from uav_launch.plot_window import PlotWindow, PlotNav, PlotAxis, PlotDiff
from uav_launch.data_storage import RosStorageInterface
...
class StatePlotter:
    ...
    def _create_state_plotter(self) -> None:
        ...
        self._plotters.append(PlotNav(
            true_data=self._data.true.gamma, true_xdata=self._data.true.time,
        ...
        self._plotters.append(PlotNav(
            ...
            nav_data=self._data.est.v_g, nav_xdata=self._data.est.time,
            true_label="$V_g$-True", nav_label="$V_g$-Est", show_legend=True,
            ax=state_axis[3,3], title="", ylabel="$m/s$", widget=widget
        ))
