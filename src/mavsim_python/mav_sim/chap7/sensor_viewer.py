"""
Similar to the data viewer from chapter 4, this module provides functionality for
viewing the sensors
"""
...
class SensorViewer:
    """Plotting capabilities for viewing the sensor data."""
    ...
    def __init__(self) -> None:
        ...
        # define third row
        gps_n_plots = PlotboxArgs(
            plots=["gps_n"],
            labels={"left": "distance(m)", "bottom": "Time (s)"},
            time_window=time_window_length,
        )
        gps_e_plots = PlotboxArgs(
            plots=["gps_e"],
            labels={"left": "distance(m)", "bottom": "Time (s)"},
            time_window=time_window_length,
        )
        gps_h_plots = PlotboxArgs(
            plots=["gps_h"],
            labels={"left": "distance(m)", "bottom": "Time (s)"},
            time_window=time_window_length,
        )
        ...
        # define fourth row
        gps_Vg_plots = PlotboxArgs(
            plots=["gps_Vg"],
            labels={"left": "gps_Vg(m/s)", "bottom": "Time (s)"},
            time_window=time_window_length,
        )
        gps_course_plots = PlotboxArgs(
            plots=["gps_course"],
    ...
    def update(self, sensors: MsgSensors, ts: float) -> None:
        """Update each of the plots

        Args:
            sensors: Sensory data
            ts: Time step
        """
        ...
        sensor_list = [
            ...
            sensors.gyro_y,
            sensors.gyro_z,
            sensors.abs_pressure,
            sensors.accel_x,
            sensors.accel_y,
            sensors.accel_z,
            sensors.diff_pressure,
            sensors.gps_n,
            sensors.gps_e,
            sensors.gps_h,
            sensors.gps_Vg,
