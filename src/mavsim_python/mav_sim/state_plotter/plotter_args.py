...
class PlotArgs:
    ...
    def __init__(
        ...
        rad2deg: Optional[bool] = None,
        max_length: Optional[int] = None,
        connect: bool = True,
        symbol: Literal["o", "d", "+", "t", "s"] = "o",
        symbol_size: float = 2,
        px_mode: bool = True,
...
class PlotboxArgs:
    ...
    def __init__(
        ...
        plots: Optional[Union[list[str], list[PlotArgs]]] = None,
        sigma_bounds: Optional[list[int]] = None,
        legend: bool = True,
        ...
        plot_hues: int = 4,
        plot_min_hue: int = 0,
        plot_max_hue: int = 270,
        plot_min_value: int = 200,
        plot_max_value: int = 255,
        is_angle: bool = False,
        rad2deg: bool = False,
    ) -> None:
        ...
        if title is not None:
            ...
            if isinstance(plots[0], PlotArgs):
                ...
                raise TypeError(
                    "plots input {} of incorrect type ({}). Expected PlotArgs or str object".format(
