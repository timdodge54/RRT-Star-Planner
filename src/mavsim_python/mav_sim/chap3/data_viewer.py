...
class DataViewer:
    ...
    def __init__(self) -> None:
        ...
        self.plotter = Plotter(
            plotting_frequency=100,  # refresh plot every 10 time steps
        ...
        wind_plots = PlotboxArgs(
            plots=["wn", "wn_e", "we", "we_e"],
        ...
        gyro_plots = PlotboxArgs(
            plots=["bx", "bx_e", "by", "by_e", "bz", "bz_e"],
        ...
        plots = [first_row, second_row, third_row, fourth_row, fifth_row]
        ...
        self.plotter.define_input_vector(
            "commands", ["h_c", "Va_c", "phi_c", "theta_c", "chi_c"]
        )
        self.plotter.define_input_vector(
    ...
    def update(
        ...
        estimated_state_list = [
            estimated_state.north,
            estimated_state.east,
            estimated_state.altitude,
            estimated_state.Va,
            estimated_state.alpha,
            estimated_state.beta,
            estimated_state.phi,
            estimated_state.theta,
            estimated_state.chi,
            estimated_state.p,
            estimated_state.q,
            estimated_state.r,
        ...
        self.plotter.add_vector_measurement(
            "estimated_state", estimated_state_list, self.time
        )
