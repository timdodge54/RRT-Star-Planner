...
class Observer:
    ...
    def __init__(
        self,
        ts_control: float,
        initial_state: MsgState = MsgState(),
        initial_measurements: MsgSensors = MsgSensors(),
    ) -> None:
...
@no_type_check
def jacobian(
    fun: types.SensorJacobianFnc,
    x: npt.NDArray[Any],
    measurement: types.JacobianMeasurement,
    state: types.JacobianState,
) -> npt.NDArray[Any]:
    """
