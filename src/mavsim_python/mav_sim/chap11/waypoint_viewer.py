...
class WaypointViewer:
    ...
    def update(self, state: MsgState, path: MsgPath, waypoints: MsgWaypoints) -> None:
        """Update the viewer given the mav state, path being followed, and the waypoints"""
